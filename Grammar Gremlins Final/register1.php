			...
			<div class="5grid-layout">
			  <div class="row main-row">
			    <div class="4u">
				  ...
				  <section>
                  <center>
						  <h2>Teacher Registration </h2><br>
						  <form action="email1.php" method="post" onSubmit="return checkForm(this);" autocomplete="off">
					    <table width="900" border="1">
                              <tr>
                                ...
                                <td ><label>
                                 ...
                                 <td >Last Name</td>
                                <td ><label>
                                  <input type="text" name="lname" id="lname" placeholder="Last Name" required pattern="[a-zA-Z0-9]{5,}" title="Minimum 2 letters or numbers.">
                                </label></td></tr>
                                  <td >Email</td>
                                <td ><label>
                                  <input type="email" name="email" id="email" placeholder="Email" pattern="[^ @]*@[^ @]*" title="Please Enter Valid Email Id">
                                </label></td></tr>
                                 <td >Password</td>
                                <td ><label>
