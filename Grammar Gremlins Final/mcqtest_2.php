...
path="http://localhost/cjam/"+ query_string.std+"/"+query_string.sub+"/"+query_string.chap+"/";
...
document.getElementById('clickme').disabled=true;
  document.getElementById("qno").innerHTML = count+"";
...
//$filecount = 0;
//$files = glob( "..//cjam//".$_GET['std']."//".$_GET['sub']."//".$_GET['chap']."//" . "*");
//if ($files){
...
//echo $filecount;
	...
	try
	{ 
	img.src= path+xmlObj.childNodes(0).childNodes(i++).firstChild.text;
	} 
	catch(e) 
	{ 	firstNode=get_firstchild(xmlObj); 
...
if(parseInt(count)<=parseInt(noq))
{
	...
	if ((parseInt(radios[i1].value) )  == parseInt(firstNode.childNodes[i].childNodes[1].childNodes[0].nodeValue))
	{
//	alert( "xml ansWer " + firstNode.childNodes[i].childNodes[1].childNodes[0].nodeValue +"Radio answer : " + (parseInt(radios[i1].value)) + "correct Answer");
if(testid==1)
{	var d = document.getElementById(firstNode.childNodes[i].childNodes[1].childNodes[0].nodeValue);
    d.style.backgroundColor='#35FF9A';
	alert("YEAH !! Correct Answer","Modern says");
}
	correct=correct +1;
	}
	...
	//alert("radio value " +radios[i1].value);
	var d = document.getElementById( radios[i1].value );
    d.style.backgroundColor='#FF7979';
	var d = document.getElementById(firstNode.childNodes[i].childNodes[1].childNodes[0].nodeValue);
    d.style.backgroundColor='#35FF9A';
	alert("OH OH !! Incorrect Answer","Modern Says");

	}
//	document.getElementById(1).style.bgcolor = '#990000';
	//document.getElementById(""+firstNode.childNodes[i].childNodes[1].childNodes[0].nodeValue).style.bgcolor = '#009900';
//	alert("xml anser " + firstNode.childNodes[i].childNodes[1].childNodes[0].nodeValue +"Radio answer : " + (parseInt(radios[i1].value)) + "incorrect Answer");
...
timer_is_on=0;
	...
	<body onLoad="timedCount();starttest();">
	<!-- ********************************************************* -->
		...
		<div id="main">
          ...
          <img src="images/clock.png" alt="C" width="30" height="31"> 
            <input name="txt" type="text"  id="txt" style="background-color:#FFFFFF ;border:none; font-size:15px" size="1">
          	<label id="lblid">Que :  </label><label id="qno">1</label>
          	/ 
          	<label id="totqno"></label>
				      ...
				      <table width="335" border="2">
                        ...
                        <tr>
                          <th width="69" >   <p class="style1"> <label id="lblstd"></label></th>
                          <th width="74" ><span class="style1">
                            <label id="lblsub"></label>
                          </span></th>
                          <th width="1" ><span class="style1">
                            <label id="lblchap"></label>
                          </span></th>
                          <th width="161" ><span class="style1">
                            <label id="lblnoques"></label>
                          </span></th>
                        </tr>
                        <tr><td>  </td></tr>
                        <tr>
    ...
    <span class="style2">SKIP</span>
                          ...
                          <td align="right"><button class="button" id="clickme" onClick="changeImage()">Next</button></td>
                        </tr>
                      </table>
