...
$con = mysqli_connect('localhost','artandcr_mcqtest','T$eWVz6S_!]&','artandcr_mcqtest');
if (!$con) {
    die('Could not connect: ' . mysqli_error($con));
}

mysqli_select_db($con,"artandcr_mcqtest");
...
$sql="SELECT * FROM questions WHERE quesid = '".$q."' and setid IN (".$sets.")";
//echo $sql;
