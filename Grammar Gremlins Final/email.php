...
$sql = "INSERT INTO `student_registration`(`fname`, `lname` , `email` , `password` , `cpassword`) VALUES (:fname,:lname,:email,:pass,:cpass)";
$STH = $dbh->prepare($sql);
...
// Create the mailer
	...
	$message = Swift_Message::newInstance('Grammer Gremlins')
		...
		->setSubject ('New Student Registration for Grammer Gremlins')
